...
static rt_err_t fh_uart_configure(struct rt_serial_device *serial, struct serial_configure *cfg)
{
	int div;
...
static rt_err_t fh_uart_control(struct rt_serial_device *serial, int cmd, void *arg)
{
    struct fh_uart* uart;
